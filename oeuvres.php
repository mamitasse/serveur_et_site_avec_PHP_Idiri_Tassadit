...
$oeuvres = [
    [
        ...
        'image' => 'img/pawel-czerwinski-3.png' // peut être modifié par une URL comme http://localhost/...
    ],
        [
        'id' => 3,
        ...
        'image' => 'img/dan-cristian-padure.png' // peut être modifié par une URL comme http://localhost/...
    ],
        [
        'id' => 4,
        ...
        'image' => 'img/steve-johnson.png' // peut être modifié par une URL comme http://localhost/...
    ],
        [
        'id' => 6,
        'titre' => 'Chromatics',
        ...
        'image' => 'img/pawel-czerwinski.png' // peut être modifié par une URL comme http://localhost/...
    ],
        [
        'id' => 7,
        ...
        'image' => 'img/jazmin-quaynor.png' // peut être modifié par une URL comme http://localhost/...
    ],
        [
        'id' => 8,
        ...
        'image' => 'img/steve-johnson-6.png' // peut être modifié par une URL comme http://localhost/...
    ],
        [
        'id' => 9,
        'titre' => 'Hurricane',
        ...
        'image' => 'img/victor-grabarczyk.png' // peut être modifié par une URL comme http://localhost/...
    ],
        [
        'id' => 10,
        ...
        'image' => 'img/pawel-czerwinski-2.png' // peut être modifié par une URL comme http://localhost/...
    ],
        [
        'id' => 11,
        'titre' => 'Asimilacion',
        ...
        'image' => 'img/steve-johnson-2.png' // peut être modifié par une URL comme http://localhost/...
    ],
        [
        'id' => 12,
        ...
        'image' => 'img/fly-d.png' // peut être modifié par une URL comme http://localhost/...
    ],
        [
        'id' => 13,
        ...
        'image' => 'img/orfeas-green.png' // peut être modifié par une URL comme http://localhost/...
    ],
        [
        'id' => 14,
        'titre' => 'Mirage',
        ...
        'image' => 'img/steve-johnson-4.png' // peut être modifié par une URL comme http://localhost/...
    ],
        [
        'id' => 15,
